...
public sealed class RoamingConfiguration : ConfigurationTemplate
{
    ...
    [JsonInclude]
    public double NormalActivationDuration
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    } = 7;
    [JsonInclude]
    public double TriggeredReleaseDuration
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    } = 60;
    [JsonInclude]
    public double NormalActivationJump
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    } = 0.05;
    [JsonInclude]
    public double TriggeredActivationJump
    {
    ...
    [JsonInclude]
    public ModelHotkey? SelectedHotkey
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    }
    [JsonInclude]
    public ModelExpression? SelectedExpression
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    }
    ...
    [JsonInclude]
    public double AuraFrameRate
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    } = 90;
    [JsonInclude]
    public double AuraFrequency
    {
        get => InterlockedHelpers.Read(ref field);
        set => Interlocked.Exchange(ref field, value);
    } = 0.5;
